...
There were no issues with the first, very simplistic app. All tested frameworks passed the test flawlessly. There was just a small problem with jQuery for Windows in Apache Cordova project. Therefore, pure JavaScript was used for all Cordova apps.
