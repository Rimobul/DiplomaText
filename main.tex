...
\begin{table}[!h]
	...
	\begin{tabular}{p{.33\textwidth} | p{.33\textwidth} | p{.34\textwidth}}
		...
		\textbf{Debugging} & Yes & \\			
		\midrule
		\textbf{Closed group shipping} & Default & Available via common app stores. \\			
		\midrule
		...
		\midrule		
		\textbf{Platform-specific UI layers} & No & Single platform-agnostic UI code-base. \\			
		\midrule
	\end{tabular}
\end{table}
...
\begin{tabular}{p{.33\textwidth} | p{.33\textwidth} | p{.34\textwidth}}
	...
	\textbf{Adaptive layout for mobile and tablet} & Yes & \\			
	\midrule		
	\textbf{Platform-specific UI layers} & Yes & Single platform-agnostic UI code-base unavailable. \\			
	\midrule
\end{tabular}
\end{table}
